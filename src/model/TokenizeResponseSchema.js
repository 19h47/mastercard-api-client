...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.TokenizeResponseSchema = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.AuthenticationMethods,
			root.MdesForMerchants.ProductConfig,
			root.MdesForMerchants.TokenDetail,
			root.MdesForMerchants.TokenInfo
		);
	}
})(this, function (
	ApiClient,
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("decision")) {
				obj["decision"] = ApiClient.convertToType(
					data["decision"],
					"String"
				);
			}
			if (data.hasOwnProperty("authenticationMethods")) {
				obj["authenticationMethods"] = ApiClient.convertToType(
					data["authenticationMethods"],
					[AuthenticationMethods]
				);
			}
			if (data.hasOwnProperty("tokenUniqueReference")) {
				obj["tokenUniqueReference"] = ApiClient.convertToType(
					data["tokenUniqueReference"],
					"String"
				);
			}
			if (data.hasOwnProperty("panUniqueReference")) {
				obj["panUniqueReference"] = ApiClient.convertToType(
					data["panUniqueReference"],
					"String"
				);
			}
			if (data.hasOwnProperty("productConfig")) {
				obj["productConfig"] = ProductConfig.constructFromObject(
					data["productConfig"]
				);
			}
			if (data.hasOwnProperty("tokenInfo")) {
				obj["tokenInfo"] = TokenInfo.constructFromObject(
					data["tokenInfo"]
				);
			}
			if (data.hasOwnProperty("tokenDetail")) {
				obj["tokenDetail"] = TokenDetail.constructFromObject(
					data["tokenDetail"]
				);
			}
		}
