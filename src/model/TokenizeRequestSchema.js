...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./DecisioningData"),
			require("./FundingAccountInfo")
		);
	} else {
		...
		root.MdesForMerchants.TokenizeRequestSchema = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.DecisioningData,
			root.MdesForMerchants.FundingAccountInfo
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("requestId")) {
				obj["requestId"] = ApiClient.convertToType(
					data["requestId"],
					"String"
				);
			}
			if (data.hasOwnProperty("tokenType")) {
				obj["tokenType"] = ApiClient.convertToType(
					data["tokenType"],
					"String"
				);
			}
			if (data.hasOwnProperty("tokenRequestorId")) {
				obj["tokenRequestorId"] = ApiClient.convertToType(
					data["tokenRequestorId"],
					"String"
				);
			}
			if (data.hasOwnProperty("taskId")) {
				obj["taskId"] = ApiClient.convertToType(
					data["taskId"],
					"String"
				);
			}
			if (data.hasOwnProperty("fundingAccountInfo")) {
				obj[
					"fundingAccountInfo"
				] = FundingAccountInfo.constructFromObject(
					data["fundingAccountInfo"]
				);
			}
			if (data.hasOwnProperty("consumerLanguage")) {
				obj["consumerLanguage"] = ApiClient.convertToType(
					data["consumerLanguage"],
					"String"
				);
			}
			if (data.hasOwnProperty("tokenizationAuthenticationValue")) {
				obj[
					...
					data["tokenizationAuthenticationValue"],
					"String"
				);
			}
			if (data.hasOwnProperty("decisioningData")) {
				obj["decisioningData"] = DecisioningData.constructFromObject(
					data["decisioningData"]
				);
			}
		}
		return obj;
