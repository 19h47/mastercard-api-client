...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.TokenDetail = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.TokenDetailData
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj["encryptedData"] = TokenDetailData.constructFromObject(
					data["encryptedData"]
				);
			}
		}
