...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.BillingAddress = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("countrySubdivision")) {
				obj["countrySubdivision"] = ApiClient.convertToType(
					data["countrySubdivision"],
					"String"
				);
			}
			if (data.hasOwnProperty("postalCode")) {
				obj["postalCode"] = ApiClient.convertToType(
					data["postalCode"],
					"String"
				);
			}
			if (data.hasOwnProperty("country")) {
				obj["country"] = ApiClient.convertToType(
					data["country"],
					"String"
				);
			}
