...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.EncryptedPayloadTransact = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.TransactEncryptedData
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj[
					"encryptedData"
				] = TransactEncryptedData.constructFromObject(
					data["encryptedData"]
				);
			}
		}
