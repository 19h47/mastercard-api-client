...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.GetTokenRequestSchema = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("paymentAppInstanceId")) {
				obj["paymentAppInstanceId"] = ApiClient.convertToType(
					data["paymentAppInstanceId"],
					"String"
				);
			}
			...
			if (data.hasOwnProperty("includeTokenDetail")) {
				obj["includeTokenDetail"] = ApiClient.convertToType(
					data["includeTokenDetail"],
					"String"
				);
			}
		}
