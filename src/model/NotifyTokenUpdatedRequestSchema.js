...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.NotifyTokenUpdatedRequestSchema = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.EncryptedPayload
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedPayload")) {
				obj["encryptedPayload"] = EncryptedPayload.constructFromObject(
