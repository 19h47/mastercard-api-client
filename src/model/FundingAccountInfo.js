...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./FundingAccountInfoEncryptedPayload")
		);
	} else {
		...
		root.MdesForMerchants.FundingAccountInfo = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.FundingAccountInfoEncryptedPayload
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("pushAccountReceipt")) {
				obj["pushAccountReceipt"] = ApiClient.convertToType(
					data["pushAccountReceipt"],
					"String"
				);
			}
			if (data.hasOwnProperty("encryptedPayload")) {
				obj[
					"encryptedPayload"
				] = FundingAccountInfoEncryptedPayload.constructFromObject(
