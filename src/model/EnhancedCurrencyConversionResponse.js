...
import EnhancedCurrencyConversionData from './EnhancedCurrencyConversionData';
 ...
 * @version 1.0.0
 */
class EnhancedCurrencyConversionResponse {
    /**
    ...
    constructor() { 
        ...
        EnhancedCurrencyConversionResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnhancedCurrencyConversionResponse();
 ...
 */
EnhancedCurrencyConversionResponse.prototype['data'] = undefined;

/**
 * The description of the API being called
 * @member {String} description
 */
EnhancedCurrencyConversionResponse.prototype['description'] = undefined;

/**
 * The name of the service being requested
 * @member {String} name
 */
EnhancedCurrencyConversionResponse.prototype['name'] = undefined;

/**
 * The date and time the API is being called in GMT
 * @member {String} requestDate
 */
EnhancedCurrencyConversionResponse.prototype['requestDate'] = undefined;
...
export default EnhancedCurrencyConversionResponse;
