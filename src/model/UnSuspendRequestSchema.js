...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.UnSuspendRequestSchema = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("tokenUniqueReferences")) {
				obj["tokenUniqueReferences"] = ApiClient.convertToType(
					data["tokenUniqueReferences"],
					["String"]
				);
			}
			if (data.hasOwnProperty("causedBy")) {
				obj["causedBy"] = ApiClient.convertToType(
					data["causedBy"],
					"String"
				);
			}
