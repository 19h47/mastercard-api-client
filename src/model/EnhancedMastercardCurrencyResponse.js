...
import EnhancedMastercardCurrencies from './EnhancedMastercardCurrencies';
 ...
 * @version 1.0.0
 */
class EnhancedMastercardCurrencyResponse {
    /**
    ...
    constructor() { 
        ...
        EnhancedMastercardCurrencyResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnhancedMastercardCurrencyResponse();
 ...
 */
EnhancedMastercardCurrencyResponse.prototype['data'] = undefined;

/**
 * The description of the API being called
 * @member {String} description
 */
EnhancedMastercardCurrencyResponse.prototype['description'] = undefined;

/**
 * The name of the service being requested
 * @member {String} name
 */
EnhancedMastercardCurrencyResponse.prototype['name'] = undefined;

/**
 * The date and time the API is being called in GMT
 * @member {String} requestDate
 */
EnhancedMastercardCurrencyResponse.prototype['requestDate'] = undefined;
...
export default EnhancedMastercardCurrencyResponse;
