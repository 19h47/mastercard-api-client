...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.TransactEncryptedData = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("applicationExpiryDate")) {
				obj["applicationExpiryDate"] = ApiClient.convertToType(
					data["applicationExpiryDate"],
					"String"
				);
			}
			if (data.hasOwnProperty("panSequenceNumber")) {
				obj["panSequenceNumber"] = ApiClient.convertToType(
					data["panSequenceNumber"],
					"String"
				);
			}
			if (data.hasOwnProperty("track2Equivalent")) {
				obj["track2Equivalent"] = ApiClient.convertToType(
					data["track2Equivalent"],
					"String"
				);
			}
			if (data.hasOwnProperty("de48se43Data")) {
				obj["de48se43Data"] = ApiClient.convertToType(
					data["de48se43Data"],
					"String"
				);
			}
