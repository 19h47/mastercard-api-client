...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./EncryptedPayloadTransact")
		);
	} else {
		...
		root.MdesForMerchants.TransactResponseSchema = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.EncryptedPayloadTransact
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedPayload")) {
				obj[
					"encryptedPayload"
				] = EncryptedPayloadTransact.constructFromObject(
