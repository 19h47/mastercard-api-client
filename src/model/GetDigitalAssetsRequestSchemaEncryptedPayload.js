...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./GetDigitalAssetsEncryptedData")
		);
	} else {
		...
		root.MdesForMerchants.GetDigitalAssetsRequestSchemaEncryptedPayload = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.GetDigitalAssetsEncryptedData
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj[
					"encryptedData"
				] = GetDigitalAssetsEncryptedData.constructFromObject(
					data["encryptedData"]
				);
			}
		}
