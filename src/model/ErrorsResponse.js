...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.ErrorsResponse = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.Error
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("errorCode")) {
				obj["errorCode"] = ApiClient.convertToType(
					data["errorCode"],
					"String"
				);
			}
			if (data.hasOwnProperty("errorDescription")) {
				obj["errorDescription"] = ApiClient.convertToType(
