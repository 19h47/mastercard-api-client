...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.ProductConfig = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("brandLogoAssetId")) {
				obj["brandLogoAssetId"] = ApiClient.convertToType(
					data["brandLogoAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("issuerLogoAssetId")) {
				obj["issuerLogoAssetId"] = ApiClient.convertToType(
					data["issuerLogoAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("isCoBranded")) {
				obj["isCoBranded"] = ApiClient.convertToType(
					data["isCoBranded"],
					"String"
				);
			}
			if (data.hasOwnProperty("coBrandName")) {
				obj["coBrandName"] = ApiClient.convertToType(
					data["coBrandName"],
					"String"
				);
			}
			if (data.hasOwnProperty("coBrandLogoAssetId")) {
				obj["coBrandLogoAssetId"] = ApiClient.convertToType(
					data["coBrandLogoAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("cardBackgroundCombinedAssetId")) {
				obj["cardBackgroundCombinedAssetId"] = ApiClient.convertToType(
					data["cardBackgroundCombinedAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("cardBackgroundAssetId")) {
				obj["cardBackgroundAssetId"] = ApiClient.convertToType(
					data["cardBackgroundAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("iconAssetId")) {
				obj["iconAssetId"] = ApiClient.convertToType(
					data["iconAssetId"],
					"String"
				);
			}
			if (data.hasOwnProperty("foregroundColor")) {
				obj["foregroundColor"] = ApiClient.convertToType(
					data["foregroundColor"],
					"String"
				);
			}
			if (data.hasOwnProperty("issuerName")) {
				obj["issuerName"] = ApiClient.convertToType(
					data["issuerName"],
					"String"
				);
			}
			if (data.hasOwnProperty("shortDescription")) {
				obj["shortDescription"] = ApiClient.convertToType(
					data["shortDescription"],
					"String"
				);
			}
			if (data.hasOwnProperty("longDescription")) {
				obj["longDescription"] = ApiClient.convertToType(
					data["longDescription"],
					"String"
				);
			}
			if (data.hasOwnProperty("customerServiceUrl")) {
				obj["customerServiceUrl"] = ApiClient.convertToType(
					data["customerServiceUrl"],
					"String"
				);
			}
			if (data.hasOwnProperty("customerServiceEmail")) {
				obj["customerServiceEmail"] = ApiClient.convertToType(
					data["customerServiceEmail"],
					"String"
				);
			}
			if (data.hasOwnProperty("customerServicePhoneNumber")) {
				obj["customerServicePhoneNumber"] = ApiClient.convertToType(
					data["customerServicePhoneNumber"],
					"String"
				);
			}
			if (data.hasOwnProperty("issuerMobileApp")) {
				obj["issuerMobileApp"] = ApiClient.convertToType(
					data["issuerMobileApp"],
					Object
				);
			}
			if (data.hasOwnProperty("onlineBankingLoginUrl")) {
				obj["onlineBankingLoginUrl"] = ApiClient.convertToType(
					data["onlineBankingLoginUrl"],
					"String"
				);
			}
			if (data.hasOwnProperty("termsAndConditionsUrl")) {
				obj["termsAndConditionsUrl"] = ApiClient.convertToType(
					data["termsAndConditionsUrl"],
					"String"
				);
			}
			if (data.hasOwnProperty("privacyPolicyUrl")) {
				obj["privacyPolicyUrl"] = ApiClient.convertToType(
					data["privacyPolicyUrl"],
					"String"
				);
			}
			if (data.hasOwnProperty("issuerProductConfigCode")) {
				obj["issuerProductConfigCode"] = ApiClient.convertToType(
					data["issuerProductConfigCode"],
					"String"
				);
			}
		}
