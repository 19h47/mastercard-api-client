...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./NotifyTokenEncryptedPayload")
		);
	} else {
		...
		root.MdesForMerchants.EncryptedPayload = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.NotifyTokenEncryptedPayload
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj[
					"encryptedData"
				] = NotifyTokenEncryptedPayload.constructFromObject(
					data["encryptedData"]
				);
			}
		}
