...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.FundingAccountInfoEncryptedPayload = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.FundingAccountData
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj["encryptedData"] = FundingAccountData.constructFromObject(
					data["encryptedData"]
				);
			}
		}
