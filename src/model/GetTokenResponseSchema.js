...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./Token"),
			require("./TokenDetailGetTokenOnly")
		);
	} else {
		...
		root.MdesForMerchants.GetTokenResponseSchema = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.Token,
			root.MdesForMerchants.TokenDetailGetTokenOnly
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("tokenDetail")) {
				obj[
					"tokenDetail"
				] = TokenDetailGetTokenOnly.constructFromObject(
					data["tokenDetail"]
				);
			}
		}
