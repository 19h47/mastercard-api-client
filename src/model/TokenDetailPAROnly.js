...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./TokenDetailDataPAROnly")
		);
	} else {
		...
		root.MdesForMerchants.TokenDetailPAROnly = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.TokenDetailDataPAROnly
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("encryptedData")) {
				obj[
					"encryptedData"
				] = TokenDetailDataPAROnly.constructFromObject(
					data["encryptedData"]
				);
			}
		}
