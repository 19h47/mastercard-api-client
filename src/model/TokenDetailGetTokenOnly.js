...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./TokenDetailDataGetTokenOnly")
		);
	} else {
		...
		root.MdesForMerchants.TokenDetailGetTokenOnly = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.TokenDetailDataGetTokenOnly
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("publicKeyFingerprint")) {
				obj["publicKeyFingerprint"] = ApiClient.convertToType(
					data["publicKeyFingerprint"],
					"String"
				);
			}
			if (data.hasOwnProperty("encryptedKey")) {
				obj["encryptedKey"] = ApiClient.convertToType(
					data["encryptedKey"],
					"String"
				);
			}
			if (data.hasOwnProperty("oaepHashingAlgorithm")) {
				obj["oaepHashingAlgorithm"] = ApiClient.convertToType(
					data["oaepHashingAlgorithm"],
					"String"
				);
			}
			if (data.hasOwnProperty("encryptedData")) {
				obj[
					"encryptedData"
				] = TokenDetailDataGetTokenOnly.constructFromObject(
					data["encryptedData"]
				);
			}
		}
