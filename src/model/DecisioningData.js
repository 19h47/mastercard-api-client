...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.DecisioningData = factory(
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("recommendation")) {
				obj["recommendation"] = ApiClient.convertToType(
					data["recommendation"],
					"String"
				);
			}
			if (data.hasOwnProperty("recommendationAlgorithmVersion")) {
				obj["recommendationAlgorithmVersion"] = ApiClient.convertToType(
					data["recommendationAlgorithmVersion"],
					"String"
				);
			}
			if (data.hasOwnProperty("deviceScore")) {
				obj["deviceScore"] = ApiClient.convertToType(
					data["deviceScore"],
					"String"
				);
			}
			if (data.hasOwnProperty("accountScore")) {
				obj["accountScore"] = ApiClient.convertToType(
					data["accountScore"],
					"String"
				);
			}
			if (data.hasOwnProperty("recommendationReasons")) {
				obj["recommendationReasons"] = ApiClient.convertToType(
					data["recommendationReasons"],
					["String"]
				);
			}
			if (data.hasOwnProperty("deviceCurrentLocation")) {
				obj["deviceCurrentLocation"] = ApiClient.convertToType(
					data["deviceCurrentLocation"],
					"String"
				);
			}
			if (data.hasOwnProperty("deviceIpAddress")) {
				obj["deviceIpAddress"] = ApiClient.convertToType(
					data["deviceIpAddress"],
					"String"
				);
			}
			if (data.hasOwnProperty("mobileNumberSuffix")) {
				obj["mobileNumberSuffix"] = ApiClient.convertToType(
					data["mobileNumberSuffix"],
					"String"
				);
			}
			if (data.hasOwnProperty("accountIdHash")) {
				obj["accountIdHash"] = ApiClient.convertToType(
					data["accountIdHash"],
					"String"
				);
			}
