...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		root.MdesForMerchants.AccountHolderData = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.BillingAddress,
			root.MdesForMerchants.PhoneNumber
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("accountHolderName")) {
				obj["accountHolderName"] = ApiClient.convertToType(
			...
			if (data.hasOwnProperty("accountHolderAddress")) {
				...
				] = BillingAddress.constructFromObject(
					data["accountHolderAddress"]
				);
			}
			if (data.hasOwnProperty("consumerIdentifier")) {
				obj["consumerIdentifier"] = ApiClient.convertToType(
					data["consumerIdentifier"],
					"String"
				);
			}
			if (data.hasOwnProperty("accountHolderEmailAddress")) {
				obj["accountHolderEmailAddress"] = ApiClient.convertToType(
					data["accountHolderEmailAddress"],
					"String"
				);
			}
			if (data.hasOwnProperty("accountHolderMobilePhoneNumber")) {
				...
				] = PhoneNumber.constructFromObject(
					data["accountHolderMobilePhoneNumber"]
				);
			}
		}
		return obj;
