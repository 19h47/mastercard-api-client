...
import ECBConversionObject from './ECBConversionObject';
import MastercardConversionObject from './MastercardConversionObject';
 ...
 * @version 1.0.0
 */
class EnhancedCurrencyConversionData {
    /**
    ...
    constructor() { 
        ...
        EnhancedCurrencyConversionData.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EnhancedCurrencyConversionData();
 ...
 */
EnhancedCurrencyConversionData.prototype['transCurr'] = undefined;

/**
 * Cardholder billing currency as provided in the API request
 * @member {String} crdhldBillCurr
 */
EnhancedCurrencyConversionData.prototype['crdhldBillCurr'] = undefined;

/**
 * The date of the requested rates
 * @member {String} rateDate
 */
EnhancedCurrencyConversionData.prototype['rateDate'] = undefined;

/**
 * Amount in transaction currency as provided in the API request
 * @member {Number} transAmt
 */
EnhancedCurrencyConversionData.prototype['transAmt'] = undefined;

/**
 * Percentage bank fee as provided in the API request
 * @member {Number} bankFeePct
 */
EnhancedCurrencyConversionData.prototype['bankFeePct'] = undefined;

/**
 * Fixed bank fee as provided in the API request
 * @member {Number} bankFeeFixed
 */
EnhancedCurrencyConversionData.prototype['bankFeeFixed'] = undefined;

/**
 * @member {module:model/MastercardConversionObject} mastercard
 */
EnhancedCurrencyConversionData.prototype['mastercard'] = undefined;

/**
 * @member {module:model/ECBConversionObject} ecb
 */
EnhancedCurrencyConversionData.prototype['ecb'] = undefined;
 ...
 */
EnhancedCurrencyConversionData.prototype['effectiveConversionRate'] = undefined;
 ...
 */
EnhancedCurrencyConversionData.prototype['pctDifferenceMastercardExclAllFeesAndEcb'] = undefined;
 ...
 */
EnhancedCurrencyConversionData.prototype['pctDifferenceMastercardInclAllFeesAndEcb'] = undefined;
...
export default EnhancedCurrencyConversionData;
