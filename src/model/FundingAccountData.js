...
(function (root, factory) {
	if (typeof define === "function" && define.amd) {
		...
		module.exports = factory(
			require("../ApiClient"),
			require("./AccountHolderData"),
			require("./CardAccountDataInbound")
		);
	} else {
		...
		root.MdesForMerchants.FundingAccountData = factory(
			root.MdesForMerchants.ApiClient,
			root.MdesForMerchants.AccountHolderData,
			root.MdesForMerchants.CardAccountDataInbound
		);
	}
	...
	exports.constructFromObject = function (data, obj) {
		if (data) {
			...
			if (data.hasOwnProperty("cardAccountData")) {
				obj[
					"cardAccountData"
				] = CardAccountDataInbound.constructFromObject(
			...
			if (data.hasOwnProperty("accountHolderData")) {
				obj[
					"accountHolderData"
				] = AccountHolderData.constructFromObject(
